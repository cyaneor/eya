...
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_CLOSED, 1, 5), 5);
}

TEST(eya_interval_size, left_open_interval)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_LEFT_OPEN, 1, 5), 4);
}

TEST(eya_interval_size, right_open_interval)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_RIGHT_OPEN, 1, 5), 4);
}
...
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_LEFT_OPEN, 5, 5), 0);
}

TEST(eya_interval_size, right_open_interval_min_equals_max)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_RIGHT_OPEN, 5, 5), 0);
}

TEST(eya_interval_size, open_interval_min_equals_max)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_OPEN, 5, 5), -1);
}

TEST(eya_interval_size, closed_interval_negative_range)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_CLOSED, 5, 1), -3);
}

TEST(eya_interval_size, left_open_interval_negative_range)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_LEFT_OPEN, 5, 1), -4);
}

TEST(eya_interval_size, right_open_interval_negative_range)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_RIGHT_OPEN, 5, 1), -4);
}

TEST(eya_interval_size, open_interval_negative_range)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_OPEN, 5, 1), -5);
}

TEST(eya_interval_size, zero_range_closed)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_CLOSED, 0, 0), 1);
}

TEST(eya_interval_size, large_values_closed)
{
    EXPECT_EQ(eya_interval_size(EYA_INTERVAL_TYPE_CLOSED, 1000000, 1000005), 6);
}
