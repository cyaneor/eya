...
TEST(eya_memory_range_get_state,
     returns_empty_for_same_non_null_begin_and_end) {
...
TEST(eya_memory_range_is_multiple_of_size,
     returns_false_for_non_multiple_size) {
...
TEST(eya_memory_range_is_multiple_of_size,
     handles_null_self_pointer_gracefully) {
  eya_usize_t element_size = 0x1000;
...
TEST(eya_memory_range_is_valid_offset,
     returns_false_for_offset_exceeding_size) {
  eya_memory_range_t range = {(void *)0x1000, (void *)0x2000}; // Size 0x1000
...
TEST(eya_memory_range_assign, copies_range_correctly) {
...
TEST(eya_memory_range_assign, handles_null_self_pointer_gracefully) {
  eya_memory_range_t src = {(void *)0x1000, (void *)0x2000};
  EXPECT_DEATH(eya_memory_range_assign(nullptr, &src), ".*");
}

TEST(eya_memory_range_assign, handles_null_other_pointer_gracefully) {
  eya_memory_range_t dst;
  EXPECT_DEATH(eya_memory_range_assign(&dst, nullptr), ".*");
}
...
TEST(eya_memory_range_set_range, sets_valid_range) {
  eya_memory_range_t range;

  eya_memory_range_set_range(&range, (void *)0x1000, (void *)0x2000);

  EXPECT_EQ(range.begin, (void *)0x1000);
  EXPECT_EQ(range.end, (void *)0x2000);
}

TEST(eya_memory_range_set_range, fails_on_invalid_range) {
  eya_memory_range_t range;

  EXPECT_DEATH(eya_memory_range_set_range(&range, nullptr, (void *)0x2000),
               ".*");
}
...
TEST(eya_memory_range_set_by_size_v, sets_range_when_begin_not_null) {
  eya_memory_range_t range;

  eya_memory_range_set_by_size_v(&range, (void *)0x1000, 0x1000);

  EXPECT_EQ(range.begin, (void *)0x1000);
  EXPECT_EQ(range.end, (void *)0x2000);
}

TEST(eya_memory_range_set_by_size_v, clears_range_when_begin_null) {
  eya_memory_range_t range = {(void *)0x1000, (void *)0x2000};

  eya_memory_range_set_by_size_v(&range, nullptr, 0x1000);
...
TEST(eya_memory_range_find_range, not_found) {
  ...
  int search[1] = {5};
  eya_memory_range_t view = {&data[0], &data[4]};
  EXPECT_EQ(eya_memory_range_find_range(&view, &search[0], &search[1]),
            nullptr);
}
...
TEST(eya_memory_range_find_range, found_multibyte) {
  ...
  EXPECT_EQ(eya_memory_range_find_range(&view, &search[0],
...
TEST(eya_memory_range_rfind_range, not_found) {
  ...
  int search[1] = {5};
  eya_memory_range_t view = {&data[0], &data[4]};
  EXPECT_EQ(eya_memory_range_rfind_range(&view, &search[0], &search[1]),
            nullptr);
}
...
TEST(eya_memory_range_rfind_range, found_multibyte) {
  ...
  char search[] = "world";
  eya_memory_range_t view = {&data[0], &data[sizeof(data) - 1]};
  EXPECT_EQ(eya_memory_range_rfind_range(&view, &search[0],
                                         &search[sizeof(search) - 1]),
            &data[12]);
}
...
TEST(eya_memory_range_compare_range, identical_content) {
  ...
  eya_memory_range_t view = {&data[0], &data[4]};
  EXPECT_EQ(eya_memory_range_compare_range(&view, &compare[0], &compare[4]),
            nullptr);
}
...
TEST(eya_memory_range_compare_range, multibyte_string) {
  ...
  eya_memory_range_t view = {&data[0], &data[sizeof(data) - 1]};
  EXPECT_EQ(eya_memory_range_compare_range(&view, &compare[0],
...
TEST(eya_memory_range_rcompare_range, empty_range) {
  int data[1] = {1};
  eya_memory_range_t view = {&data[0], &data[0]};
  EXPECT_EQ(eya_memory_range_rcompare_range(&view, &data[0], &data[1]),
            nullptr);
}
...
TEST(eya_memory_range_rcompare_range, empty_compare_range) {
  int data[4] = {1, 2, 3, 4};
  eya_memory_range_t view = {&data[0], &data[4]};
  EXPECT_EQ(eya_memory_range_rcompare_range(&view, &data[0], &data[0]),
            nullptr);
}
...
TEST(eya_memory_range_rcompare_range, identical_content) {
  ...
  int compare[4] = {1, 2, 3, 4};
  eya_memory_range_t view = {&data[0], &data[4]};
  EXPECT_EQ(eya_memory_range_rcompare_range(&view, &compare[0], &compare[4]),
            nullptr);
}
...
TEST(eya_memory_range_rcompare_range, multibyte_string) {
  ...
  eya_memory_range_t view = {&data[0], &data[sizeof(data) - 1]};
  EXPECT_EQ(eya_memory_range_rcompare_range(&view, &compare[0],
                                            &compare[sizeof(compare) - 1]),
            &data[10]);
}
