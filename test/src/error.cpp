...
TEST(eya_error, get_desc) {
  eya_error_t err = {.desc = "Test error"};
...
TEST(eya_error, unpack) {
  eya_error_t err = {.code = EYA_ERROR_CODE_SOME_ERROR, .desc = "Test error"};
...
TEST(eya_error, assign) {
  eya_error_t err = {};
  eya_error_t other = {.code = EYA_ERROR_CODE_SOME_ERROR, .desc = "Test error"};
...
TEST(eya_error, is_code) {
  eya_error_t err = {.code = EYA_ERROR_CODE_SOME_ERROR, .desc = "Test error"};
  EXPECT_TRUE(eya_error_is_code(&err, EYA_ERROR_CODE_SOME_ERROR));
  EXPECT_FALSE(eya_error_is_code(&err, EYA_ERROR_CODE_NONE));
}

TEST(eya_error, is_code_equal) {
  eya_error_t err1 = {.code = EYA_ERROR_CODE_SOME_ERROR, .desc = "Test error"};
  eya_error_t err2 = {.code = EYA_ERROR_CODE_SOME_ERROR, .desc = "Other error"};
  EXPECT_TRUE(eya_error_is_code_equal(&err1, &err2));
  eya_error_t err3 = {.code = EYA_ERROR_CODE_NONE, .desc = "Test error"};
  EXPECT_FALSE(eya_error_is_code_equal(&err1, &err3));
}

TEST(eya_error, is_ok) {
  eya_error_t err = {.code = EYA_ERROR_CODE_NONE, .desc = nullptr};
  EXPECT_TRUE(eya_error_is_ok(&err));
  eya_error_t err2 = {.code = EYA_ERROR_CODE_SOME_ERROR, .desc = "Test error"};
