...
/**
 * @def EYA_USIZE_T_MIN
 * @brief Minimum value (0) for unsigned size type (64-bit)
 */
...
/**
 * @def EYA_USIZE_T_MIN
 * @brief Minimum value (0) for unsigned size type (32-bit)
 */
...
/**
 * @def EYA_USIZE_T_MIN
 * @brief Minimum value (0) for unsigned size type (16-bit)
 */
...
/**
 * @def EYA_USIZE_T_MIN
 * @brief Minimum value (0) for unsigned size type (8-bit)
 */
