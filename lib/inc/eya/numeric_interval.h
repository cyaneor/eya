 ...
 * Each interval consists of interval bounds (lower and upper) and an interval type.
 * By default, all intervals use @ref EYA_INTERVAL_TYPE_CLOSED.
 *
 * Defined constants:
