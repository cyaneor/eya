 ...
 * @brief Initializes a typed memory range with element size information
 ...
 * @code
 * int array[10];
 * // Initialize with element size (for int typically 4 bytes)
...
#define eya_memory_typed_initializer(begin, end, element_size)                                     \
    eya_memory_range_initializer(begin, end, element_size)

/**
 * @def eya_memory_typed_empty_initializer(element_size)
 * @brief Creates an empty typed memory range with element size information
 * @param element_size Size of each element in bytes
