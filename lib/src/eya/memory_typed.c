...
{
    return eya_ptr_cast(const eya_memory_range_t, self);
}
...
{
    const eya_memory_range_t *range = eya_memory_typed_get_crange(self);
...
eya_memory_typed_at_from_front(const eya_memory_typed_t *self, eya_usize_t index)
{
    ...
    return eya_memory_range_at_from_front(range, offset);
}
...
{
    const eya_memory_range_t *self_range  = eya_memory_typed_get_crange(self);
    const eya_memory_range_t *other_range = eya_memory_typed_get_crange(other);
