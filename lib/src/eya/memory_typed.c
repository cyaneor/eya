...
{
    eya_memory_range_unpack(eya_ptr_rcast(const eya_memory_range_t, self), begin, end);
...
eya_memory_typed_is_valid(const eya_memory_typed_t *self)
{
    ...
    return eya_memory_range_is_multiple_of_size(eya_ptr_rcast(const eya_memory_range_t, self),
                                                element_size);
}
...
eya_memory_typed_get_size(const eya_memory_typed_t *self)
{
    ...
    const eya_usize_t size =
        eya_memory_range_get_size(eya_ptr_rcast(const eya_memory_range_t, self));
...
eya_memory_typed_swap(eya_memory_typed_t *self, eya_memory_typed_t *other)
{
    ...
    eya_memory_range_swap(eya_ptr_rcast(eya_memory_range_t, self),
                          eya_ptr_rcast(eya_memory_range_t, other));
}
...
eya_memory_typed_exchange(eya_memory_typed_t *self, eya_memory_typed_t *other)
{
    ...
    eya_memory_range_exchange(eya_ptr_rcast(eya_memory_range_t, self),
                              eya_ptr_rcast(eya_memory_range_t, other));
}
...
eya_memory_typed_at_from_front(const eya_memory_typed_t *self, eya_usize_t index)
{
    ...
    return eya_memory_range_at_from_front(eya_ptr_rcast(const eya_memory_range_t, self), offset);
}
...
eya_memory_typed_is_equal(const eya_memory_typed_t *self, const eya_memory_typed_t *other)
{
    return eya_memory_typed_is_equal_element_size(self, other) &&
           eya_memory_range_is_equal(eya_ptr_rcast(const eya_memory_range_t, self),
                                     eya_ptr_rcast(const eya_memory_range_t, other));
}
...
eya_memory_typed_make(void *begin, void *end, eya_usize_t element_size)
{
    ...
    eya_memory_range_reset(eya_ptr_rcast(eya_memory_range_t, &self), begin, end);
    return self;
}