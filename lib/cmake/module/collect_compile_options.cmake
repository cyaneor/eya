...
foreach (CMAKE_OPTION IN ITEMS ${CMAKE_OPTIONS})
    if (CMAKE_OPTION MATCHES "^EYA_COMPILE_OPTION_.*")    
            ...
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID MATCHES "GNU|Clang")
                    ...
                    if(COMPILER_SUPPORTS_SSE2)
                        ...
                        message(WARNING "Compiler doesn't support SSE2 instructions")
                    endif()
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
            ...
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID MATCHES "GNU|Clang")
                    ...
                    if(COMPILER_SUPPORTS_AVX2)
                        ...
                        message(WARNING "Compiler doesn't support AVX2 instructions")
                    endif()
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
            ...
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID MATCHES "GNU|Clang")
                    ...
                    if(COMPILER_SUPPORTS_AVX512)
                        ...
                        message(WARNING "Compiler doesn't support AVX512 instructions")
                    endif()
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
            ...
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
                    ...
                    if(COMPILER_SUPPORTS_LTO)
                        eya_add_compile_option_if_missing(-flto=auto)
                    else()
                        message(WARNING "GCC compiler doesn't support LTO (built with --disable-lto)")
                    endif()
        ...
        if (CMAKE_OPTION STREQUAL "EYA_COMPILE_OPTION_PARALLEL")
            if (${CMAKE_OPTION} STREQUAL "ON")
                if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
                    check_c_compiler_flag(-floop-parallelize-all COMPILER_SUPPORTS_PARALLEL)
                    if(COMPILER_SUPPORTS_PARALLEL)
                        eya_add_compile_option_if_missing(-floop-parallelize-all)
                        eya_add_compile_option_if_missing(-ftree-parallelize-loops=4)
                    else()
                        message(WARNING "Compiler doesn't support loop parallelization")
                    endif()
                elseif (CMAKE_C_COMPILER_ID STREQUAL "Clang")
                    check_c_compiler_flag(-mllvm COMPILER_SUPPORTS_LLVM_OPTIONS)
                    if(COMPILER_SUPPORTS_LLVM_OPTIONS)
                        ...
                        message(WARNING "Clang doesn't support polly parallelization")
                    endif()
                elseif (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
